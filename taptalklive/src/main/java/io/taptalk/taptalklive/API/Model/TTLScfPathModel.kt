...
@Parcelize data class TTLScfPathModel(
    ...
    @field:JsonProperty("apiURL") var apiURL: String = "",
    @field:JsonProperty("contentOnAPIError") var contentOnAPIError: String = "",
    @field:JsonProperty("contentResponse") var contentResponse: String = "",
